                ...
                <div class="row">
                    <div class="col-12">
                        <div class="block-heading d-flex align-items-center title-pages">
                            <h5 class="text-truncate">Editar Exercício</h5>
                        </div>
                    </div>
...
<div class="form-row">
    <div class="form-group col-md-12">
        ...
        <input value="<?php echo $exercise['exercise_rest']; ?>" placeholder="Descanso" name="exercise_rest" class="form-control" required="">

        <label class="control-label">Séries</label>
        <input value="<?php echo $exercise['exercise_sets']; ?>" placeholder="Séries" name="exercise_sets" class="form-control" required="">

        <label class="control-label">Repetições</label>
        <input value="<?php echo $exercise['exercise_reps']; ?>" placeholder="Repetições" name="exercise_reps" class="form-control" required="">

        <label class="control-label">URL do Vídeo (MP4)</label>
        <input type="text" value="<?php echo $exercise['exercise_video']; ?>" placeholder="URL do Vídeo (MP4)" name="exercise_video" class="form-control" required="">
        ...
        <div class="action-button">
            <input type="submit" name="update" value="Atualizar" class="btn btn-embossed btn-primary">
            <a onclick="alertdelete();">
            <input name="trash" value="Excluir" class="btn btn-embossed btn-danger" style="width: 80px;"></a>
            <script type="text/javascript">
            function alertdelete() {
            swal({ title: "Tem certeza?", text: "Não será possível recuperar este item!", type: "warning",cancelButtonClass: "btn-default btn-sm", showCancelButton: true, confirmButtonClass: "btn-danger btn-sm", confirmButtonText: "Sim, delete!", closeOnConfirm: false }, function(){window.location.href = "<?php echo SITE_URL ?>/controller/delete_exercise.php?id=<?php echo $exercise['exercise_id']; ?>" });}
            </script>
        </div>
    </div>
</div>
